...
<head>
  ...
  <style>
    {{ font_ready_css|safe }}
    /* ألوان عامة: brand #12a4b4 | brand-2 #0f7d89 | light #e9f7f9 | border #c5d6de | text #2b2d31 */
    ...
    *{ font-family: inherit !important; }
    ...
    .card{ background:#fff; border-radius:8px; border:1.2px solid #c5d6de; margin-bottom:8px; page-break-inside: avoid; }
    .pad{ padding:6px 8px; }
    ...
    table.meta td.label, table.meta3 td.label{
      font-weight:700; background:#e9f7f9; color:#0f7d89;
    }
    ...
    table.meta3.resp{ border-color:#f3c099; }
    table.meta3.resp th, table.meta3.resp td{ border-color:#f3c099; }
    table.meta3.resp td.label{
      width:18%;
      background:#fff3e6;   /* مظلل لطيف */
      color:#b35c00;
    }
    table.meta3.resp td.value{
      width:82%;
      background:#fffaf4;   /* خفيف جداً للقيم */
    }
    ...
    .fill{
      ...
      border-bottom:1px dotted #c5d6de;
      min-width:40mm;
      height:1.2em;
    ...
    .cb{ width:4.2mm; height:4.2mm; border:1.2px solid #0f7d89; border-radius:2px; display:inline-block; margin-bottom:3px; }
